...
class kpVisionPage extends StatelessWidget {
  kpVisionPage({super.key});
final currentUser = FirebaseAuth.instance.currentUser!;
  ...
  Future<void> submitReview(BuildContext context) async {
    ...
    FirebaseFirestore.instance.collection('tinir').doc('2').collection("reviews").add(reviewData);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('KP Vison Boarding House'),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'This is a paragraph describing KP Vision Boarding House. Add your text here.',
