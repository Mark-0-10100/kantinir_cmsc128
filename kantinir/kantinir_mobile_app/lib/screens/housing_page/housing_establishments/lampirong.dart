...
class lampirongPage extends StatelessWidget {
  lampirongPage({super.key});
final currentUser = FirebaseAuth.instance.currentUser!;
  ...
  Future<void> submitReview(BuildContext context) async {
    ...
    FirebaseFirestore.instance.collection('tinir').doc('4').collection("reviews").add(reviewData);
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'This is a paragraph describing Balay Lampirong. Add your text here.',
