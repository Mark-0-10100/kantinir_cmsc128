...
class elGarajePage extends StatelessWidget {
  ...
  Future<void> submitReview(BuildContext context) async {
    ...
    FirebaseFirestore.instance.collection('kaon').doc('1').collection("reviews").add(reviewData);
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'This is a paragraph describing El Garaje. Add your text here.',
